...
const sections: DocSection[] = [
  ...
  { id: "deploy-mainnet", title: "Stellar Mainnet Deployment", category: "Deployment" },
  ...
  { id: "security-audit", title: "Security Model & Defenses", category: "Smart Contracts" },
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-[#0d131f]/90 backdrop-blur-md border-b border-slate-800/80 px-4 lg:px-8 py-3.5 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <button
            ...
            className="lg:hidden p-2 text-slate-400 hover:text-white bg-slate-800/60 rounded-md border border-slate-700/50"
...
+------------------------------------+------------------------------------+
          ...
          <section id="setup-prerequisites" className="mb-14 scroll-mt-24">
            ...
            <h3 className="text-base font-semibold text-white mb-2">5.2 Frontend Installation</h3>
...
npm run dev`}
            ...
            <h3 className="text-base font-semibold text-white mb-2 mt-6">5.3 Smart Contract Compilation</h3>
            <div className="bg-[#0f172a] border border-slate-800 rounded-lg overflow-hidden my-3">
              <div className="bg-[#1e293b]/60 px-4 py-2 flex items-center justify-between border-b border-slate-800 text-xs font-mono text-slate-400">
...
Tests:       22 passed, 22 total (100% Pass Rate)`}
          ...
          <section id="deploy-testnet" className="mb-14 scroll-mt-24">
            <h2 className="text-2xl font-bold text-white tracking-tight mb-4 flex items-center gap-2.5">
              <span>6. On-Chain Deployment & Verification</span>
            </h2>

            <div className="bg-[#131b2b] border border-slate-800 rounded-lg p-4 text-xs font-mono text-slate-300 space-y-2 mb-6">
              <div><strong>Network Passphrase:</strong> <code>Test SDF Network ; September 2015</code></div>
              <div><strong>Soroban RPC URL:</strong> <code>https://soroban-testnet.stellar.org</code></div>
              <div><strong>Horizon RPC URL:</strong> <code>https://horizon-testnet.stellar.org</code></div>
          ...
          {/* SECTION 7: Level Verification */}
          <section id="level-verification" className="mb-14 scroll-mt-24">
            <h2 className="text-2xl font-bold text-white tracking-tight mb-4 flex items-center gap-2.5">
              <span>7. Bootcamp Belt Level Verification Matrix (Levels 2–7)</span>
            </h2>
