        ...
        <div className="max-w-6xl mx-auto px-4 flex items-center justify-between">
          ...
          <Link href="/" className="flex items-center gap-2.5 font-bold text-lg text-white group">
            <img
              src="/logo.jpg"
              alt="SplitSync Logo"
              className="w-8 h-8 rounded-lg object-cover border border-emerald-mint/40 shadow-md shadow-emerald-mint/20 group-hover:scale-105 transition-all"
            />
            <span className="tracking-tight font-extrabold">SplitSync</span>
          </Link>
        ...
        <div className="max-w-6xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex flex-col items-center md:items-start gap-2">
            <Link href="/" className="flex items-center gap-2 font-bold text-white text-base">
              <img src="/logo.jpg" alt="SplitSync Logo" className="w-6 h-6 rounded-md object-cover border border-emerald-mint/40" />
              SplitSync
            </Link>
          ...
          <div className="flex items-center gap-4 text-muted-silver">
            <a href="https://github.com/brad-git03/Split_Sync_Stellar" target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="hover:text-white transition-colors">
